...
const CardBack = ({className}: {className?: string}) => {
    return (
        <div className={cn("w-14 sm:w-16 md:w-24 lg:w-28 h-24 sm:h-32 md:h-40 lg:h-44 rounded-xl bg-[#4d4d4d] border-2 border-gray-700 relative overflow-hidden cursor-pointer", className)}>
