...
const Menu = () => {
    ...
    return (
          <div className="flex flex-row-reverse sm:flex-row justify-start sm:justify-center w-screen sm:w-full overflow-x-auto sm:overflow-visible p-2 gap-3 no-scrollbar">
            ...
            <div className="flex-shrink-0 w-36 sm:w-40 sm:h-52  md:w-44 md:h-56 xl:w-52 h-44 xl:h-64 lg:rounded-lg  bg-[#4d4d4d] border sm:border-2 border-red-500 shadow-red-glow relative overflow-hidden cursor-pointer sm:-ml-12 rounded-md sm:rounded-lg 
            ...
            onClick={() => setShowNewRoomForm(true)}>
                <Image src='/icns/diamonds.png' alt="Heart Icon" width={24} height={24} className="absolute left-1 sm:left-2 top-1 sm:top-2 w-6 sm:w-10 h-5 sm:h-10"/>
                <Image src='/icns/diamonds.png' alt="Heart Icon" width={24} height={24} className="absolute right-1 sm:right-2 bottom-1 sm:bottom-2 w-6 sm:w-10 h-5 sm:h-10"/>
